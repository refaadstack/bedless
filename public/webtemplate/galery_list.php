...
-->
    ...
    <span>View Style:</span>
		<a href="galery.php" title="Grid"><img src="assets/img/icon/grid.png" style="width:20px;" alt=""></a>
        &nbsp;
        ...
        <ul>			
			<?php if($nume > $limit ){
				  if($back >=0) { 
				  print "<li>
				  <a href='galery_list.php?start=$back' class='prev'>
				  ...
				  if($i <> $eu){
				  echo "<li><a href='galery_list.php?start=$i'>$l</a></li>  ";
				  } else { 
				  ...
				  if($this1 < $nume) { 
				  print " <li>
				  <a href='galery_list.php?start=$next' class='next'>
