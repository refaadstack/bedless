...
-->
    ...
    <span>View Style:</span>
		<a href="#grid" title="Grid"><img src="assets/img/icon/grid.png" style="width:20px;" alt=""></a>
        &nbsp;
		<a href="galery_list.php" title="List"><img src="assets/img/icon/list.png" style="width:20px;" alt=""></a>
        <?php 	$sql= mysql_query("select * from produk where stok > 0 ");
	...
	<h3>Our Products </h3>
		<div class="row-fluid">
		  <ul class="thumbnails">
          <?php $sql="select * from produk where stok > 0 $order limit $eu, $limit";
        ...
        <ul>			
			<?php if($nume > $limit ){
				  if($back >=0) { 
				  print "<li>
				  <a href='galery.php?start=$back' class='prev'>
				  ...
				  if($i <> $eu){
				  echo "<li><a href='galery.php?start=$i'>$l</a></li>  ";
				  } else { 
				  ...
				  if($this1 < $nume) { 
				  print " <li>
				  <a href='galery.php?start=$next' class='next'>
