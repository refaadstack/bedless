...
<?php include('sidebar.php');?>
 ...
 <table class="table table-bordered table-hover table-condensed">
    ...
    <?php $sql = mysql_query("SELECT p.*, w.* FROM pemesanan p left join wilayah w on w.namawilayah=p.alamatkirim where kodemember = '$_SESSION[kodemember]' order by TanggalPemesanan desc");
	  while($hasil = mysql_fetch_array($sql)){ $status=$hasil['Status'];
?>
<tr class="active">
        ...
        <td align="center">
        <a class="btn btn-primary" href="konfirmasi_pembayaran.php?kode=<?php echo $hasil['kodepemesanan'];?>"> Konfirmasi Pembayaran </a></td>
        <?php { ?>
