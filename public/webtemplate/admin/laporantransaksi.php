...
<table width="100%" border = 0 cellspacing = 0>
			...
			<td align =center><p>
			  <h1>Omdut Coffee</h1>
			  <h3>Laporan Pemesanan Online</h3>
			...
			where Month(TanggalPemesanan) = $_POST[bulan] And Year(TanggalPemesanan) = $_POST[tahun]";
...
<table width="100%" border="1" cellpadding="10" cellspacing = 0 class="bordered">
 ...
 <td align="center"><?php echo "Rp." . number_format($record['harga_barang'] *  $record['jumlah'],0,',','.') ; ?></td>
 <td align="center"><?php echo $record['TanggalPemesanan'] ; ?></td><tr>


<?php $no +=1 ;
$total = $total + ($record['harga_barang'] *  $record['jumlah']);
} ?>
